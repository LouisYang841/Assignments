...
| C     | Consequence logic is centralised in dedicated classes; different AlarmSystem instances can mix and match different consequence combinations; easy to disable or swap consequences independently | Consequence classes will directly interact with GameEntity, creates strong coupling if without an abstraction while further abstraction will be unnecessary under current scope.                                                                                |
