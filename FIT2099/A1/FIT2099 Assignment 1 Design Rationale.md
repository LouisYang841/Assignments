...
- **Alternative C** centeralizes the consequence logic, but at the cost of breaking responder's encapsulation, which is **against the Information Hiding.
...
The requirement specifically requires the system to be robust and scalable, to show that my implementation is so, I summarized the application of S.O.L.I.D. principles of this alarm system here.
